...
**Status:** Milestone 0 (due diligence) and Milestone 1 (infra bootstrap) are complete. Milestone 2 (data & secrets) is next. See the [build order doc](docs/weather-outfit-advisor-build-order.md) for the full milestone plan.
...
- Milestone 2 — Data & Secrets *(not started)*
